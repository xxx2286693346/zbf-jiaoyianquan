...
public class YanZhengMa {
    ...
    public boolean sendSms(@RequestParam("phone") String phone) throws ClientException {
        ...
        String accessKeyId = "LTAI4G6utMZdQvYjFoWLsCjJ";
        String accessKeySecret = "Gk555ctCBfIlr4CJ4oxO16nzpdb4Nj";
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("LJYCH");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_202552327");
